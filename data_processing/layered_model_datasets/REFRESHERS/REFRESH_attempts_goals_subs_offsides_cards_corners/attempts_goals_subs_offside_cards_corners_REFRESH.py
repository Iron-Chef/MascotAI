...
# The ratio should be 3:3:1:1:2:1 (in order)
...
combined_dataset = attempts_sample + goals_sample + substitutions_sample + offsides_sample + cards_sample + corners_sample
random.shuffle(combined_dataset)

# Write to a new JSONL file
write_jsonl('../REFRESH_attempts_goals_subs_offsides_cards_corners.jsonl', combined_dataset)